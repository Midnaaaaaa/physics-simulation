...
void SceneProjectiles::reset() {
    ...
    klinear = widget->getKLinear();
    kquadratic = widget->getKQuadratic();

    double interpolationNumber = widget->getReynoldsNumber() / (double)1000;
    fDrag1->setDragCoefficients(klinear * 1-interpolationNumber, kquadratic * interpolationNumber);
    fDrag2->setDragCoefficients(klinear * 1-interpolationNumber, kquadratic * interpolationNumber);

...
private:
    void computeProvot(const int i, const int j);
    void setProvotStretchSprings(const int i, const int j);
    void setProvotShearSprings(const int i, const int j);
    void setProvotBendSprings(const int i, const int j);

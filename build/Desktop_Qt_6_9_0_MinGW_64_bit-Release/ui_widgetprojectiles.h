...
public:
    ...
    void setupUi(QWidget *WidgetProjectiles)
    {
        ...
        label_9 = new QLabel(WidgetProjectiles);
        label_9->setObjectName("label_9");

        formLayout->setWidget(10, QFormLayout::ItemRole::LabelRole, label_9);

        reynolds = new QDoubleSpinBox(WidgetProjectiles);
        reynolds->setObjectName("reynolds");
        reynolds->setMaximum(1000.000000000000000);

        formLayout->setWidget(10, QFormLayout::ItemRole::FieldRole, reynolds);
    ...
    void retranslateUi(QWidget *WidgetProjectiles)
    {
        ...
        label_9->setText(QCoreApplication::translate("WidgetProjectiles", "Reynolds number", nullptr));
    } // retranslateUi
